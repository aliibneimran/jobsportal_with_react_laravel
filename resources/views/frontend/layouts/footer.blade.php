<footer class="footer mt-50">
      <div class="container">
        <div class="row">
          <div class="footer-col-1 col-md-3 col-sm-12"><a href="index.html"><img alt="jobBox" src="{{asset('frontend/imgs/template/jobhub-logo.svg')}}"></a>
          ...
          <div class="footer-col-6 col-md-3 col-sm-12">
            ...
            <div class="mt-15"><a class="mr-5" href="#"><img src="{{asset('frontend/imgs/template/icons/app-store.png')}}" alt="joxBox"></a><a href="#"><img src="{{asset('frontend/imgs/template/icons/android.png')}}" alt="joxBox"></a></div>
          </div>
        </div>
